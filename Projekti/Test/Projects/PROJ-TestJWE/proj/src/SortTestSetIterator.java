...
import si.fri.algotest.execute.TestSetIterator;
 ...
 * @author tomaz
 */
public class SortTestSetIterator extends TestSetIterator {
  ...
  // a line last read from a file
  private String currentInputLine;
  
  private void reportInvalidDataFormat(String note) {
    String msg = String.format("Invalid input data in file  in line 0.", testFileName, lineNumber);
    if (!note.isEmpty())
      msg += " ("+note+")";
